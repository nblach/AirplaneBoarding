...
As can be seen from our results, different boarding methods can lead to significantly different boarding times. Thus, when aiming to ensure quick boarding- and turn times, choosing an effective boarding method is crucial. In this paper, we analyze the effectiveness of a variety of different boarding methods mentioned in \ref{Beus}, as well as the "Steffen" method, which was proposed by Steffen \ref{steffen} in 2008 and is supposed to be the best known boarding method as of today.
